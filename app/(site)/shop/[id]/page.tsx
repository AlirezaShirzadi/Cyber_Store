            ...
            <Container>
                ...
                <section className="pb-24 pt-4">
                    <div className="grid grid-cols-12 gap-6 items-center">
                        <div className="col-span-12 lg:col-span-6">
                            <ShopItemSlider
                                data={shopItemDetails?.data?.galleries}
                            />
                        </div>
                        <div className="col-span-12 lg:col-span-6">
                ...
                <section className="pb-24 pt-4 lg:py-[157px]">
                    ...
                    <div className="my-8 lg:my-[110px] hidden lg:grid grid-cols-12 gap-6">
                        {relatedProducts?.data?.results?.map((item: any) => {
                            return (
                                <ShopItem
                                    key={item?.id}
                                    item={item}
                ...
                <section className="pb-24 pt-4">
                    ...
                    <div className="grid grid-cols-12 gap-6">
                        {shopItemDetails?.data?.comments?.map((item: any) => {
                            return <TestimonialItem key={'testimonial ' + id + item} item={item} />
                        })}
                    </div>
                </section>
            </Container>
