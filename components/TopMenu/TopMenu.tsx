    ...
    return (
        <header className={`container mx-auto relative`}>
            ...
            >
                ...
                <div
                    className={`hidden lg:flex items-center gap-x-[23px] text-primary text-base font-light`}
                >
                    ...
                    <div className="relative">
                        {isSearchOpen ? (
                            ...
                            >
                                ...
                                >
                                    <path
                                        d="M8.04297 1.5C11.9327 1.5 15.0859 4.65324 15.0859 8.54297C15.0859 12.4327 11.9327 15.5859 8.04297 15.5859C4.15324 15.5859 1 12.4327 1 8.54297C1.00005 4.65327 4.15327 1.50005 8.04297 1.5Z"
                                        stroke="#7673D5"
                                        strokeWidth="2"
                                    />
                                    <rect
                                        ...
                                        height="9.2853"
                                        rx="1"
                                        transform="rotate(-45 12.0645 14.9343)"
                                        fill="#7673D5"
                                    />
                                </svg>
                            </button>
            ...
            <div
                ref={drawerRef}
                className={`lg:hidden fixed top-0 right-0 h-full w-[250px] bg-white shadow-lg z-50 transform transition-transform duration-300 ease-in-out ${
            ...
            >
                <div className="p-4 flex flex-col h-full">
                    ...
                    <div
                        className="text-primary text-base font-light mb-4"
                        dir="ltr"
                    >
                        {currentTime}
                    </div>
